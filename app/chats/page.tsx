...
// Get organization ID from localStorage (same as settings page)
                        ...
                        setChats(prev => {
                            ...
                            return data.map((c: any) => {
                                ...
                                return {
                                    ...
                                    visitor: `Visitor ${c.visitorId.slice(-4)}`,
                                    lastMsg: existing?.lastMsg || c.messages?.[0]?.text || "No messages",
        ...
        const updateChatsWithNewMessage = (msg: any) => {
            ...
            setChats(prev => {
                ...
                const chatData = {
                    ...
                    visitor: (existingChat?.visitor) || `Visitor ${msg.visitorId?.slice(-4) || '....'}`,
                    lastMsg: msg.text,
                ...
                <div className="flex-1 bg-[rgb(var(--surface-muted))] h-full overflow-hidden">
                    {selectedChatId ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-center p-8 bg-[rgb(var(--surface))]">
                            ...
                            <h2 className="text-xl font-semibold text-[rgb(var(--foreground))] mb-2">Select a Conversation</h2>
                            <p className="text-sm text-[rgb(var(--foreground-secondary))] max-w-[280px] leading-relaxed mx-auto">
                                Choose a chat from the sidebar to view the conversation and reply to your visitors.
                            </p>
